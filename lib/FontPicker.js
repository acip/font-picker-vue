...
__vue_render__._withStripped = true;
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-4d5bf6f6_0", { source: "\n@charset \"UTF-8\";\n.font-picker {\n  position: relative;\n  display: inline-block;\n  box-shadow: inset 0px -2px 2px rgba(0, 0, 0, 0.08);\n  border: 1px solid #BDC1CB;\n  background: #fff;\n  height: 20px;\n  border-radius: 2px;\n}\n.font-picker * {\n    box-sizing: border-box;\n}\n.font-picker p {\n    margin: 0;\n    padding: 0;\n}\n.font-picker button {\n    background: none;\n    border: 0;\n    color: inherit;\n    cursor: pointer;\n    font-size: inherit;\n    outline: none;\n}\n.font-picker .dropdown-button {\n    width: 100%;\n    display: flex;\n    align-items: center;\n    justify-content: space-between;\n    background: transparent;\n    line-height: 1;\n}\n.font-picker .dropdown-button:hover, .font-picker .dropdown-button.expanded, .font-picker .dropdown-button:focus {\n      background: #bebebe;\n}\n.font-picker .dropdown-button .dropdown-font-name {\n      overflow: hidden;\n      white-space: nowrap;\n}\n.font-picker .dropdown-button.expanded .dropdown-icon.finished:before {\n      -webkit-transform: rotate(-180deg);\n      transform: rotate(-180deg);\n}\n.font-picker .dropdown-icon.loading:before {\n    content: '';\n    display: block;\n    height: 10px;\n    width: 10px;\n    border-radius: 50%;\n    border: 2px solid #b2b2b2;\n    border-top-color: black;\n    -webkit-animation: spinner 0.6s linear infinite;\n    animation: spinner 0.6s linear infinite;\n}\n.font-picker .dropdown-icon.finished:before {\n    content: '';\n    display: block;\n    height: 0;\n    width: 0;\n    border-left: 5px solid transparent;\n    border-right: 5px solid transparent;\n    border-top: 6px solid black;\n    transition: -webkit-transform 0.3s;\n    transition: transform 0.3s, -webkit-transform 0.3s;\n    margin: 0 2px;\n}\n.font-picker .dropdown-icon.error:before {\n    content: '⚠';\n}\n.font-picker ul {\n    position: absolute;\n    z-index: 1;\n    max-height: 0;\n    width: 210px;\n    overflow-x: hidden;\n    overflow-y: auto;\n    -webkit-overflow-scrolling: touch;\n    margin: 0;\n    padding: 0;\n    background: #EAEAEA;\n    box-shadow: 1px 1px 3px rgba(0, 0, 0, 0.2);\n    transition: 0.3s;\n}\n.font-picker ul.expanded {\n      max-height: 200px;\n}\n.font-picker ul li {\n      height: 35px;\n      list-style: none;\n}\n.font-picker ul li button {\n        height: 100%;\n        width: 100%;\n        display: flex;\n        align-items: center;\n        padding: 0 10px;\n        white-space: nowrap;\n}\n.font-picker ul li button:hover, .font-picker ul li button:focus {\n          background: #dddddd;\n}\n.font-picker ul li button.active-font {\n          background: #d1d1d1;\n}\n@-webkit-keyframes spinner {\nto {\n    -webkit-transform: rotate(360deg);\n    transform: rotate(360deg);\n}\n}\n@keyframes spinner {\nto {\n    -webkit-transform: rotate(360deg);\n    transform: rotate(360deg);\n}\n}\n\n/*# sourceMappingURL=FontPicker.vue.map */", map: {"version":3,"sources":["FontPicker.vue","C:\\xampp\\htdocs\\font-picker-vue/C:\\xampp\\htdocs\\font-picker-vue/C:\\xampp\\htdocs\\font-picker-vue\\src\\FontPicker.vue"],"names":[],"mappings":";AAAA,iBAAiB;ACmPjB;EACA,mBAAA;EACA,sBAAA;EACA,mDAAA;EACA,0BAAA;EACA,iBAAA;EACA,aAAA;EACA,mBAAA;CAmHA;AA1HA;IAUA,uBAAA;CACA;AAXA;IAcA,UAAA;IACA,WAAA;CACA;AAhBA;IAmBA,iBAAA;IACA,UAAA;IACA,eAAA;IACA,gBAAA;IACA,mBAAA;IACA,cAAA;CACA;AAzBA;IA4BA,YAAA;IACA,cAAA;IACA,oBAAA;IACA,+BAAA;IACA,wBAAA;IACA,eAAA;CAeA;AAhDA;MAoCA,oBAAA;CACA;AArCA;MAwCA,iBAAA;MACA,oBAAA;CACA;AA1CA;MA6CA,mCAAA;MACA,2BAAA;CACA;AA/CA;IAqDA,YAAA;IACA,eAAA;IACA,aAAA;IACA,YAAA;IACA,mBAAA;IACA,0BAAA;IACA,wBAAA;IACA,gDAAA;IACA,wCAAA;CACA;AA9DA;IAiEA,YAAA;IACA,eAAA;IACA,UAAA;IACA,SAAA;IACA,mCAAA;IACA,oCAAA;IACA,4BAAA;IACA,mCAAA;IACA,mDAAA;IACA,cAAA;CACA;AA3EA;IA8EA,aAAA;CAAA;AA9EA;IAmFA,mBAAA;IACA,WAAA;IACA,cAAA;IACA,aAAA;IACA,mBAAA;IACA,iBAAA;IACA,kCAAA;IACA,UAAA;IACA,WAAA;IACA,oBAAA;IACA,2CAAA;IACA,iBAAA;CA2BA;AAzHA;MAiGA,kBAAA;CACA;AAlGA;MAqGA,aAAA;MACA,iBAAA;CAkBA;AAxHA;QAyGA,aAAA;QACA,YAAA;QACA,cAAA;QACA,oBAAA;QACA,gBAAA;QACA,oBAAA;CASA;AAvHA;UAiHA,oBAAA;CACA;AAlHA;UAqHA,oBAAA;CACA;AAMA;AACA;IACA,kCAAA;IACA,0BAAA;CAAA;CAAA;AAIA;AACA;IACA,kCAAA;IACA,0BAAA;CAAA;CAAA;;ADtRA,0CAA0C","file":"FontPicker.vue","sourcesContent":["@charset \"UTF-8\";\n.font-picker {\n  position: relative;\n  display: inline-block;\n  box-shadow: inset 0px -2px 2px rgba(0, 0, 0, 0.08);\n  border: 1px solid #BDC1CB;\n  background: #fff;\n  height: 20px;\n  border-radius: 2px; }\n  .font-picker * {\n    box-sizing: border-box; }\n  .font-picker p {\n    margin: 0;\n    padding: 0; }\n  .font-picker button {\n    background: none;\n    border: 0;\n    color: inherit;\n    cursor: pointer;\n    font-size: inherit;\n    outline: none; }\n  .font-picker .dropdown-button {\n    width: 100%;\n    display: flex;\n    align-items: center;\n    justify-content: space-between;\n    background: transparent;\n    line-height: 1; }\n    .font-picker .dropdown-button:hover, .font-picker .dropdown-button.expanded, .font-picker .dropdown-button:focus {\n      background: #bebebe; }\n    .font-picker .dropdown-button .dropdown-font-name {\n      overflow: hidden;\n      white-space: nowrap; }\n    .font-picker .dropdown-button.expanded .dropdown-icon.finished:before {\n      -webkit-transform: rotate(-180deg);\n      transform: rotate(-180deg); }\n  .font-picker .dropdown-icon.loading:before {\n    content: '';\n    display: block;\n    height: 10px;\n    width: 10px;\n    border-radius: 50%;\n    border: 2px solid #b2b2b2;\n    border-top-color: black;\n    -webkit-animation: spinner 0.6s linear infinite;\n    animation: spinner 0.6s linear infinite; }\n  .font-picker .dropdown-icon.finished:before {\n    content: '';\n    display: block;\n    height: 0;\n    width: 0;\n    border-left: 5px solid transparent;\n    border-right: 5px solid transparent;\n    border-top: 6px solid black;\n    transition: -webkit-transform 0.3s;\n    transition: transform 0.3s, -webkit-transform 0.3s;\n    margin: 0 2px; }\n  .font-picker .dropdown-icon.error:before {\n    content: '⚠'; }\n  .font-picker ul {\n    position: absolute;\n    z-index: 1;\n    max-height: 0;\n    width: 210px;\n    overflow-x: hidden;\n    overflow-y: auto;\n    -webkit-overflow-scrolling: touch;\n    margin: 0;\n    padding: 0;\n    background: #EAEAEA;\n    box-shadow: 1px 1px 3px rgba(0, 0, 0, 0.2);\n    transition: 0.3s; }\n    .font-picker ul.expanded {\n      max-height: 200px; }\n    .font-picker ul li {\n      height: 35px;\n      list-style: none; }\n      .font-picker ul li button {\n        height: 100%;\n        width: 100%;\n        display: flex;\n        align-items: center;\n        padding: 0 10px;\n        white-space: nowrap; }\n        .font-picker ul li button:hover, .font-picker ul li button:focus {\n          background: #dddddd; }\n        .font-picker ul li button.active-font {\n          background: #d1d1d1; }\n\n@-webkit-keyframes spinner {\n  to {\n    -webkit-transform: rotate(360deg);\n    transform: rotate(360deg); } }\n\n@keyframes spinner {\n  to {\n    -webkit-transform: rotate(360deg);\n    transform: rotate(360deg); } }\n\n/*# sourceMappingURL=FontPicker.vue.map */",null]}, media: undefined });
